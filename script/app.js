        ...
        <div class="card bg-base-100  shadow-sm">
          ...
          <div class="card-body ">
                ...
                <div class="card-actions flex   mt-5">
                    <button class="btn btn-outline text-[#0E7A81]"><svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-4">
                    ...
                    <button class="btn btn-outline text-[#0E7A81]">Adopt</button>
                    <button class="btn btn-outline text-[#0E7A81]">Details</button>
                </div>
          </div>
        </div>
        `
